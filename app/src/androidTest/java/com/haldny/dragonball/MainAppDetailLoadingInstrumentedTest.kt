...
class MainAppDetailLoadingInstrumentedTest {
    ...
    val characterDetailRepository: CharacterDetailRepository =
        FakeCharacterDetailRepository(FakeCharacterDetailRepository.Scenario.LoadingForever)

    @Test
    fun detail_screen_shows_loading() {
        ...
        composeRule.waitUntil(timeoutMillis = 10_000) {
            composeRule.onAllNodes(hasTestTag(CharacterDetailTestTags.LOADING))
                .fetchSemanticsNodes()
                .isNotEmpty()
        }
